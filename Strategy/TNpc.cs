...
namespace Strategy
{
    public class TNpc : TMonster
    {
        ...
        //public TGame Game;
        public TMap Map { get { return (TMap)Collect.Owner; } }
        public bool Enabled;
        ...
        public override void NextFrame()
        {
            ...
            if (this == Map.Game.ActiveNpc && ActPathCellIdx == Path.Count - 1)
            {
                ActPathCellIdx = 0;
                Sequence = 0;
                Path = new List<TCell>();
                //Path = DefaultPath;
                Map.Game.ActiveNpc = null;
                if (Map.Game.ActiveScript != null)
                    Map.Game.ActiveScript.IsWaiting = false;
            }
