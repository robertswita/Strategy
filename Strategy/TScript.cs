    ...
    public class TScript
    {
        ...
        public void Run()
        {
            ...
            switch (command[0])
            {
                case "teleport":
                    ...
                    break;
                case "setmap":
                    var scr = new TIniReader($"{Game.Map.GamePath}/Ref/Map.ini");
                ...
                case "createnpc":
                    ...
                    scr = new TIniReader($"{Game.Map.GamePath}/NpcInGame/Eventnpc.ref");
        ...
        void SetMap(int mapIdx, float x, float y)
        {
            ...
            if (mapName != Game.Map.MapName)
                Game.Map.ReadMap($"{Game.Map.GamePath}/Map/{mapName}.map");
