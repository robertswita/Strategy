...
namespace Strategy
{
    public partial class TBoard : UserControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            /*
            var vp = Viewport;
            var sx = Game.TileWidth / 2;
            var sy = Game.TileHeight / 2;
            vp = new Rectangle(vp.Left / sx, vp.Top / sy, vp.Width / sx, vp.Height / sy);
            vp.Inflate(2, 2);
            //vp.Intersect(new Rectangle(0, 0, Game.Map.Width + Game.Map.Height, Game.Map.Width + Game.Map.Height));
            ...
            for (int y_ = vp.Top; y_ < vp.Bottom; y_++)
                for (int x_ = vp.Left; x_ < vp.Right; x_+= 2)
                {
                    ...
                    if (pos.X < 0 || pos.X >= Game.Map.Width || pos.Y < 0 || pos.Y >= Game.Map.Height) continue;
                    //x *= Game.TileWidth / 2;
                    //y *= Game.TileHeight / 2;
