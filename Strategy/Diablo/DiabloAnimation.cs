...
namespace Strategy.Diablo
{
    ...
    {       
        ...
        DiabloAnimationLayer[] Layers = new DiabloAnimationLayer[16];
        ...
        public void ReadCof()
        {
            ...
            for (var i = 0; i < LayersCount; i++)
            {
                ...
                layer.Filename = basePath + $"{ArmorClassNames[idx]}/{Token}{ArmorClassNames[idx]}{armor}{Mode}{layer.WeaponClass}.dcc";
